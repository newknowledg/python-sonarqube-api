API_ALM_INT_IMPORT_GITLAB_ENDPOINT = "/api/alm_integrations/import_gitlab_project"
API_ALM_INT_LIST_AZURE_ENDPOINT = "/api/alm_integrations/list_azure_projects"
API_ALM_INT_LIST_BITBUCKET_ENDPOINT = "/api/alm_integrations/list_bitbucketserver_projects"
API_ALM_INT_SEARCH_AZURE_ENDPOINT = "/api/alm_integrations/search_azure_repos"
API_ALM_INT_SEARCH_BITBUCKETCLOUD_ENDPOINT = "/api/alm_integrations/search_bitbucketcloud_repos"
API_ALM_INT_SEARCH_BITBUCKETSERVER_ENDPOINT = "/api/alm_integrations/search_bitbucketserver_repos"
API_ALM_INT_SEARCH_GITLAB_ENDPOINT = "/api/alm_integrations/search_bitbucketserver_repos"
API_ALM_INT_SET_PAT_ENDPOINT = "/api/alm_integrations/set_pat"

API_ALM_SET_COUNT_BINDING_ENDPOINT = "/api/alm_settings/count_binding"
API_ALM_SET_CREATE_AZ_ENDPOINT = "/api/alm_settings/create_azure"
API_ALM_SET_CREATE_BIT_ENDPOINT = "/api/alm_settings/create_bitbucket"
API_ALM_SET_CREATE_BITCLOUD_ENDPOINT = "/api/alm_settings/create_bitbucketcloud"
API_ALM_SET_CREATE_GITHUB_ENDPOINT = "/api/alm_settings/create_github"
API_ALM_SET_CREATE_GITLAB_ENDPOINT = "/api/alm_settings/create_gitlab"
API_ALM_SET_DELETE_ENDPOINT = "/api/alm_settings/delete"
API_ALM_SET_DELETE_BIND_ENDPOINT = "/api/alm_settings/delete_binding"
API_ALM_SET_GET_ENDPOINT = "/api/alm_settings/get_binding"
API_ALM_SET_LIST_ENDPOINT = "/api/alm_settings/list"
API_ALM_SET_LIST_DEF_ENDPOINT = "/api/alm_settings/list_definitions"

API_ALM_SET_AZURE_BIND_ENDPOINT = "/api/alm_settings/set_azure_binding"
API_ALM_SET_BIT_BIND_ENDPOINT = "/api/alm_settings/set_bitbucket_binding"
API_ALM_SET_BITCLOUD_BIND_ENDPOINT = "/api/alm_settings/set_bitbucketcloud_binding"
API_ALM_SET_GITHUB_BIND_ENDPOINT = "/api/alm_settings/set_github_binding"
API_ALM_SET_GITLAB_BIND_ENDPOINT = "/api/alm_settings/set_gitlab_binding"

API_ALM_SET_UPDATE_AZURE_ENDPOINT = "/api/alm_settings/update_azure"
API_ALM_SET_UPDATE_BITBUCKET_ENDPOINT = "/api/alm_settings/update_bitbucket"
API_ALM_SET_UPDATE_BITBUCKETCLOUD_ENDPOINT = "/api/alm_settings/update_bitbucketcloud"
API_ALM_SET_UPDATE_GITHUB_ENDPOINT = "/api/alm_settings/update_github"
API_ALM_SET_UPDATE_GITLAB_ENDPOINT = "/api/alm_settings/update_gitlab"
API_ALM_SET_VALIDATE_ENDPOINT = "/api/alm_settings/validate"

API_ANALYSIS_ENDPOINT = "/api/analysis_cache/get"

API_APPLICATIONS_ADD_ENDPOINT = "/api/applications/add_project"
...
API_APPLICATIONS_REMOVE_ENDPOINT = "/api/applications/remove_project"
...
API_COMPONENTS_SEARCH_ENDPOINT = "/api/components/search"
API_COMPONENTS_TREE_ENDPOINT = "/api/components/tree"
...
API_USERS_UPDATE_IDENTITY_PROVIDER_ENDPOINT = "/api/users/update_identity_provider"
...
API_COMPONENT_SEARCH_ENDPOINT = "/api/component/search"
API_COMPONENT_SHOW_ENDPOINT = "/api/component/show"
API_COMPONENT_TREE_ENDPOINT = "/api/component/tree"
...
API_PERMISSIONS_ADD_GROUP_TO_TEMP_ENDPOINT = "/api/permissions/add_group_to_template"
API_PERMISSIONS_ADD_USER_ENDPOINT = "/api/permissions/add_user"
API_PERMISSIONS_ADD_USER_TO_TEMP_ENDPOINT = "/api/permissions/add_user_to_template"
API_PERMISSIONS_USER_GROUP_TO_TEMP_ENDPOINT = "/api/permissions/user_group_to_template"
API_PERMISSIONS_ADD_PROJECT_CREATOR_TO_TEMP_ENDPOINT = "/api/permissions/add_group_to_template"
...
API_PERMISSIONS_REMOVE_GROUP_FROM_TEMP_ENDPOINT = "/api/permissions/remove_group_to_template"
API_PERMISSIONS_REMOVE_PROJECT_CREATOR_TO_TEMP_ENDPOINT = "/api/permissions/add_group_to_template"
API_PERMISSIONS_REMOVE_USER_ENDPOINT = "/api/permissions/remove_user"
API_PERMISSIONS_REMOVE_USER_TO_TEMP_ENDPOINT = "/api/permissions/remove_user_to_template"
...
API_PLUGINS_INSTALL_ENDPOINT = "/api/plugins/insall"
API_PLUGINS_INSTALLED_ENDPOINT = "/api/plugins/insalled"
...
API_ISSUES_DO_TRANS_ENDPOINT = "/api/issues/do_transition"
API_ISSUES_REINDEX_ENDPOINT = "/api/issues/reindex"
API_ISSUES_SEVERITY_ENDPOINT = "/api/issues/set_severity"
...
API_SYSTEM_LOG_ENDPOINT = "/api/system/logs"
...
API_QUALITYPROFILES_DEACTIVE_RULE_ENDPOINT = "/api/qualityprofiles/deactive_rule"
API_QUALITYPROFILES_DEACTIVE_RULES_ENDPOINT = "/api/qualityprofiles/deactive_rules"
...
API_HOTSPOT_SEARCH_ENDPOINT = "/api/hotspot/search"
API_HOTSPOT_SHOW_ENDPOINT = "/api/hotspot/show"
...
API_PROJECT_PULL_REQUESTS_ENDPOINT = "/api/project_pull_requests/list"
...
API_VIEWS_ADD_APPLICATION_ENDPOINT = "/api/views/add_application"
API_VIEWS_ADD_APPLICATION_BRANCH_ENDPOINT = "/api/views/add_application_branch"
API_VIEWS_ADD_PORTFOLIO_ENDPOINT = "/api/views/add_portfolio"
API_VIEWS_ADD_PROJECT_ENDPOINT = "/api/views/add_project"
API_VIEWS_ADD_PROJECT_BRANCH_ENDPOINT = "/api/views/add_project_branch"
API_VIEWS_APPLICATIONS_ENDPOINT = "/api/views/applications"
API_VIEWS_CREATE_ENDPOINT = "/api/views/create"
API_VIEWS_DELETE_ENDPOINT = "/api/views/delete"
API_VIEWS_MOVE_ENDPOINT = "/api/views/move"
API_VIEWS_MOVE_OPTIONS_ENDPOINT = "/api/views/move_options"
API_VIEWS_PORTFOLIOS_ENDPOINT = "/api/views/portfolios"
API_VIEWS_REMOVE_APPLICATION_ENDPOINT = "/api/views/remove_application"
API_VIEWS_REMOVE_APPLICATION_BRANCH_ENDPOINT = "/api/views/remove_application_branch"
API_VIEWS_REMOVE_PORTFOLIO_ENDPOINT = "/api/views/remove_portfolio"
API_VIEWS_REMOVE_PROJECT_ENDPOINT = "/api/views/remove_project"
API_VIEWS_REMOVE_PROJECT_BRANCH_ENDPOINT = "/api/views/remove_project_branch"
API_VIEWS_SET_MANUAL_MODE_ENDPOINT = "/api/views/set_manual_mode"
API_VIEWS_SET_NONE_MODE_ENDPOINT = "/api/views/set_none_mode"
API_VIEWS_SET_NONE_MODE_ENDPOINT = "/api/views/set_none_mode"
API_VIEWS_SET_REGEXP_MODE_ENDPOINT = "/api/views/set_regexp_mode"
API_VIEWS_SET_REMAINING_PROJECTS_MODE_ENDPOINT = "/api/views/set_remaining_projects_mode"
API_VIEWS_SET_TAGS_MODE_ENDPOINT = "/api/views/set_tags_mode"
